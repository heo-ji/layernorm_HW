...
design_libs=(xilinx_vip axi_infrastructure_v1_1_0 xil_defaultlib axi_vip_v1_1_19)
...
compile()
{
  vlogan -work xilinx_vip $vlogan_opts -sverilog +incdir+"../../../ipstatic/hdl" +incdir+"/home/linuxusr/tools/Vivado/2024.2/data/xilinx_vip/include" \
  ...
  vlogan -work axi_infrastructure_v1_1_0 $vlogan_opts +v2k +incdir+"../../../ipstatic/hdl" +incdir+"/home/linuxusr/tools/Vivado/2024.2/data/xilinx_vip/include" \
  "../../../ipstatic/hdl/axi_infrastructure_v1_1_vl_rfs.v" \
  2>&1 | tee -a compile.log; cat .tmp_log >> vlogan.log 2>/dev/null

  vlogan -work xil_defaultlib $vlogan_opts -sverilog +incdir+"../../../ipstatic/hdl" +incdir+"/home/linuxusr/tools/Vivado/2024.2/data/xilinx_vip/include" \
  "../../../../layernorm_axi_wrapper_1_0/src/axi_lite_master_vip_0/sim/axi_lite_master_vip_0_pkg.sv" \
  2>&1 | tee -a compile.log; cat .tmp_log >> vlogan.log 2>/dev/null

  vlogan -work axi_vip_v1_1_19 $vlogan_opts -sverilog +incdir+"../../../ipstatic/hdl" +incdir+"/home/linuxusr/tools/Vivado/2024.2/data/xilinx_vip/include" \
...
elaborate()
{
  vcs $vcs_elab_opts xil_defaultlib.axi_lite_master_vip_0 xil_defaultlib.glbl -o axi_lite_master_vip_0_simv
}

# RUN_STEP: <simulate>
simulate()
{
  ./axi_lite_master_vip_0_simv $vcs_sim_opts -do simulate.do
}
...
reset_run()
{
  files_to_remove=(ucli.key axi_lite_master_vip_0_simv vlogan.log vhdlan.log compile.log elaborate.log simulate.log .tmp_log .vlogansetup.env .vlogansetup.args .vcs_lib_lock scirocco_command.log lib_sc.so 64 AN.DB csrc axi_lite_master_vip_0_simv.daidir vcs_lib c.obj)
