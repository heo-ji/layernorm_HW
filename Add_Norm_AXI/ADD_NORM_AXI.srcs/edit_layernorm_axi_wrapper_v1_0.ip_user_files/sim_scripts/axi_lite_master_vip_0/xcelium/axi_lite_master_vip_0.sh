...
#
# Script generated by Vivado on Tue May 12 13:45:21 KST 2026
# SW Build 5239630 on Fri Nov 08 22:34:34 MST 2024
#
# Copyright 1986-2022 Xilinx, Inc. All Rights Reserved.
# Copyright 2022-2024 Advanced Micro Devices, Inc. All Rights Reserved. 
#
# Filename     : axi_lite_master_vip_0.sh
...
#
# Usage        : axi_lite_master_vip_0.sh
#                axi_lite_master_vip_0.sh [-lib_map_path] [-step] [-keep_index] [-noclean_files]*
#                axi_lite_master_vip_0.sh [-reset_run]
#                axi_lite_master_vip_0.sh [-reset_log]
#                axi_lite_master_vip_0.sh [-help]
#
...
#                script (type 'axi_lite_master_vip_0.sh -help' for more information).
#
...
design_libs_elab="-libname xilinx_vip -libname axi_infrastructure_v1_1_0 -libname xil_defaultlib -libname axi_vip_v1_1_19 -libname xilinx_vip -libname unisims_ver -libname unimacro_ver -libname secureip"

# set design libraries
design_libs=(simprims_ver xilinx_vip axi_infrastructure_v1_1_0 xil_defaultlib axi_vip_v1_1_19)

# simulation root library directory
sim_lib_dir="xcelium_lib"

# script info
echo -e "axi_lite_master_vip_0.sh - Script generated by export_simulation (Vivado v2024.2 (64-bit)-id)\n"
...
run()
{
  ...
  if [[ ($b_step == 1) ]]; then
    case $step in
      ...
      ;;
      * )
        echo -e "ERROR: Invalid or missing step '$step' (type \"./axi_lite_master_vip_0.sh -help\" for more information)\n"
        exit 1
      esac
  else
    init_lib
...
compile()
{
  ...
  xmvlog -work axi_infrastructure_v1_1_0 $xmvlog_opts +incdir+"../../../ipstatic/hdl" +incdir+"/home/linuxusr/tools/Vivado/2024.2/data/xilinx_vip/include" \
  ...
  xmvlog -work axi_vip_v1_1_19 $xmvlog_opts -sv +incdir+"../../../ipstatic/hdl" +incdir+"/home/linuxusr/tools/Vivado/2024.2/data/xilinx_vip/include" \
...
elaborate()
{
  xmelab $xmelab_opts $design_libs_elab xil_defaultlib.axi_lite_master_vip_0 xil_defaultlib.glbl
}

# RUN_STEP: <simulate>
simulate()
{
  xmsim $xmsim_opts xil_defaultlib.axi_lite_master_vip_0 -input simulate.do
}
...
reset_run()
{
  files_to_remove=(xmvlog.log xmvhdl.log xmsc.log compile.log elaborate.log simulate.log diag_report.log xsc_report.log axi_lite_master_vip_0_sc.so .tmp_log xcelium_lib waves.shm c.obj)
...
check_arg_value()
{
  ...
  if [[ ($1 == "-lib_map_path") && ($2 == "") ]];then
    echo -e "ERROR: Simulation library directory path not specified (type \"./axi_lite_master_vip_0.sh -help\" for more information)\n"
    exit 1
  fi
}
...
usage()
{
  msg="Usage: axi_lite_master_vip_0.sh [-help]\n\
Usage: axi_lite_master_vip_0.sh [-step]\n\
Usage: axi_lite_master_vip_0.sh [-lib_map_path]\n\
Usage: axi_lite_master_vip_0.sh [-reset_run]\n\
Usage: axi_lite_master_vip_0.sh [-reset_log]\n\
Usage: axi_lite_master_vip_0.sh [-keep_index]\n\
Usage: axi_lite_master_vip_0.sh [-noclean_files]\n\n\
