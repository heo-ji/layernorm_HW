...
// Date        : Wed May 13 13:45:53 2026
// Host        : jhnotebook running 64-bit Ubuntu 20.04.4 LTS
// Command     : write_verilog -force -mode synth_stub
//               /mnt/c/Study/Source/2026/Add_Norm_AXI/ADD_NORM_AXI.gen/sources_1/ip/layernorm_axi_wrapper_0/layernorm_axi_wrapper_0_stub.v
...
(* CHECK_LICENSE_TYPE = "layernorm_axi_wrapper_0,layernorm_axi_wrapper,{}" *) (* CORE_GENERATION_INFO = "layernorm_axi_wrapper_0,layernorm_axi_wrapper,{x_ipProduct=Vivado 2024.2,x_ipVendor=xilinx.com,x_ipLibrary=user,x_ipName=layernorm_axi_wrapper,x_ipVersion=1.0,x_ipCoreRevision=7,x_ipLanguage=VERILOG,x_ipSimLanguage=MIXED,C_S00_AXI_DATA_WIDTH=32,C_S00_AXI_ADDR_WIDTH=5,C_S00_AXIS_TDATA_WIDTH=512,C_M00_AXIS_TDATA_WIDTH=512,C_M00_AXIS_START_COUNT=32,MODULE_NUM=32,DATA_WIDTH=16,ACCUM_DATA_WIDTH=26,SQUARED_ACCUM_DATA_WIDTH=34,SHIFT_WIDTH=8,MODEL_DIMENSION_WIDTH=11,FRAC_WIDTH=8,SQUARED_MEAN_DATA_WIDTH=32,VAR_DATA_WIDTH=24,LUT_NUM=24,START_INDEX=16,SHIFT_VALUE_DATA_WIDTH=5}" *) (* DowngradeIPIdentifiedWarnings = "yes" *) 
(* X_CORE_INFO = "layernorm_axi_wrapper,Vivado 2024.2" *) 
module layernorm_axi_wrapper_0(s00_axi_aclk, s00_axi_aresetn, 
...
/* synthesis syn_force_seq_prim="s00_axi_aclk" */;
  ...
  (* X_INTERFACE_INFO = "xilinx.com:signal:clock:1.0 M00_AXIS_CLK CLK" *) (* X_INTERFACE_MODE = "slave" *) (* X_INTERFACE_PARAMETER = "XIL_INTERFACENAME M00_AXIS_CLK, ASSOCIATED_BUSIF M00_AXIS, ASSOCIATED_RESET m00_axis_aresetn, FREQ_HZ 100000000, FREQ_TOLERANCE_HZ 0, PHASE 0.0, INSERT_VIP 0" *) input m00_axis_aclk;
