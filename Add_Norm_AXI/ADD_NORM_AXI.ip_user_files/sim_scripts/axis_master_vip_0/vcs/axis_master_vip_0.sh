...
design_libs=(xilinx_vip axis_infrastructure_v1_1_1 xil_defaultlib axi4stream_vip_v1_1_19)
...
compile()
{
  ...
  vlogan -work axis_infrastructure_v1_1_1 $vlogan_opts +v2k +incdir+"../../../ipstatic/hdl" +incdir+"/home/linuxusr/tools/Vivado/2024.2/data/xilinx_vip/include" \
  ...
  vlogan -work axi4stream_vip_v1_1_19 $vlogan_opts -sverilog +incdir+"../../../ipstatic/hdl" +incdir+"/home/linuxusr/tools/Vivado/2024.2/data/xilinx_vip/include" \
...
elaborate()
{
  vcs $vcs_elab_opts xil_defaultlib.axis_master_vip_0 xil_defaultlib.glbl -o axis_master_vip_0_simv
}

# RUN_STEP: <simulate>
simulate()
{
  ./axis_master_vip_0_simv $vcs_sim_opts -do simulate.do
}
...
create_lib_mappings()
{
  ...
  if [[ ($lib_map_path == "") ]]; then
    lib_map_path="/mnt/c/Study/Source/2026/Add_Norm_AXI/ADD_NORM_AXI.cache/compile_simlib/vcs"
  fi
...
reset_run()
{
  files_to_remove=(ucli.key axis_master_vip_0_simv vlogan.log vhdlan.log compile.log elaborate.log simulate.log .tmp_log .vlogansetup.env .vlogansetup.args .vcs_lib_lock scirocco_command.log lib_sc.so 64 AN.DB csrc axis_master_vip_0_simv.daidir vcs_lib c.obj)
