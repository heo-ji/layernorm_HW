...
#
# Script generated by Vivado on Wed May 13 10:19:35 KST 2026
# SW Build 5239630 on Fri Nov 08 22:34:34 MST 2024
#
# Copyright 1986-2022 Xilinx, Inc. All Rights Reserved.
# Copyright 2022-2024 Advanced Micro Devices, Inc. All Rights Reserved. 
#
# Filename     : axis_master_vip_0.sh
...
#
# Usage        : axis_master_vip_0.sh
#                axis_master_vip_0.sh [-lib_map_path] [-step] [-keep_index] [-noclean_files]*
#                axis_master_vip_0.sh [-reset_run]
#                axis_master_vip_0.sh [-reset_log]
#                axis_master_vip_0.sh [-help]
#
...
#                script (type 'axis_master_vip_0.sh -help' for more information).
#
...
design_libs_elab="-libname xilinx_vip -libname axis_infrastructure_v1_1_1 -libname xil_defaultlib -libname axi4stream_vip_v1_1_19 -libname xilinx_vip -libname unisims_ver -libname unimacro_ver -libname secureip"

# set design libraries
design_libs=(simprims_ver xilinx_vip axis_infrastructure_v1_1_1 xil_defaultlib axi4stream_vip_v1_1_19)

# simulation root library directory
sim_lib_dir="xcelium_lib"

# script info
echo -e "axis_master_vip_0.sh - Script generated by export_simulation (Vivado v2024.2 (64-bit)-id)\n"
...
run()
{
  ...
  if [[ ($b_step == 1) ]]; then
    case $step in
      ...
      ;;
      * )
        echo -e "ERROR: Invalid or missing step '$step' (type \"./axis_master_vip_0.sh -help\" for more information)\n"
        exit 1
      esac
  else
    init_lib
...
compile()
{
  xmvlog -work xilinx_vip $xmvlog_opts -sv +incdir+"../../../ipstatic/hdl" +incdir+"/home/linuxusr/tools/Vivado/2024.2/data/xilinx_vip/include" \
  ...
  xmvlog -work axis_infrastructure_v1_1_1 $xmvlog_opts +incdir+"../../../ipstatic/hdl" +incdir+"/home/linuxusr/tools/Vivado/2024.2/data/xilinx_vip/include" \
  "../../../ipstatic/hdl/axis_infrastructure_v1_1_vl_rfs.v" \
  2>&1 | tee -a compile.log; cat .tmp_log >> xmvlog.log 2>/dev/null

  xmvlog -work xil_defaultlib $xmvlog_opts -sv +incdir+"../../../ipstatic/hdl" +incdir+"/home/linuxusr/tools/Vivado/2024.2/data/xilinx_vip/include" \
  "../../../../ADD_NORM_AXI.gen/sources_1/ip/axis_master_vip_0/sim/axis_master_vip_0_pkg.sv" \
  2>&1 | tee -a compile.log; cat .tmp_log >> xmvlog.log 2>/dev/null

  xmvlog -work axi4stream_vip_v1_1_19 $xmvlog_opts -sv +incdir+"../../../ipstatic/hdl" +incdir+"/home/linuxusr/tools/Vivado/2024.2/data/xilinx_vip/include" \
...
elaborate()
{
  xmelab $xmelab_opts $design_libs_elab xil_defaultlib.axis_master_vip_0 xil_defaultlib.glbl
}

# RUN_STEP: <simulate>
simulate()
{
  xmsim $xmsim_opts xil_defaultlib.axis_master_vip_0 -input simulate.do
}
...
create_lib_mappings()
{
  ...
  if [[ ($lib_map_path == "") ]]; then
    lib_map_path="/mnt/c/Study/Source/2026/Add_Norm_AXI/ADD_NORM_AXI.cache/compile_simlib/xcelium"
  fi
...
reset_run()
{
  files_to_remove=(xmvlog.log xmvhdl.log xmsc.log compile.log elaborate.log simulate.log diag_report.log xsc_report.log axis_master_vip_0_sc.so .tmp_log xcelium_lib waves.shm c.obj)
...
check_arg_value()
{
  ...
  if [[ ($1 == "-lib_map_path") && ($2 == "") ]];then
    echo -e "ERROR: Simulation library directory path not specified (type \"./axis_master_vip_0.sh -help\" for more information)\n"
    exit 1
  fi
}
...
usage()
{
  msg="Usage: axis_master_vip_0.sh [-help]\n\
Usage: axis_master_vip_0.sh [-step]\n\
Usage: axis_master_vip_0.sh [-lib_map_path]\n\
Usage: axis_master_vip_0.sh [-reset_run]\n\
Usage: axis_master_vip_0.sh [-reset_log]\n\
Usage: axis_master_vip_0.sh [-keep_index]\n\
Usage: axis_master_vip_0.sh [-noclean_files]\n\n\
