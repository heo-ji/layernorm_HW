...
# set xvlog options
xvlog_opts="--incr --relax  -L axi_vip_v1_1_19 -L axi4stream_vip_v1_1_19 -L xilinx_vip"
...
elaborate()
{
  xelab --incr --debug typical --relax --mt 8  -L xil_defaultlib -L xilinx_vip -L unisims_ver -L unimacro_ver -L secureip -L xpm --snapshot layernorm_axi_wrapper_0 xil_defaultlib.layernorm_axi_wrapper_0 xil_defaultlib.glbl -log elaborate.log
}

# RUN_STEP: <simulate>
simulate()
{
  xsim layernorm_axi_wrapper_0 -key {Behavioral:sim_1:Functional:layernorm_axi_wrapper_0} -tclbatch cmd.tcl -log simulate.log
}
...
reset_run()
{
  files_to_remove=(xelab.pb xsim.jou xvhdl.log xvlog.log compile.log elaborate.log simulate.log xelab.log xsim.log run.log xvhdl.pb xvlog.pb layernorm_axi_wrapper_0.wdb xsim.dir libdpi.so)
