...
compile()
{
  xmvlog -work xilinx_vip $xmvlog_opts -sv +incdir+"/home/linuxusr/tools/Vivado/2024.2/data/xilinx_vip/include" \
  ...
  xmvlog -work xil_defaultlib $xmvlog_opts +incdir+"/home/linuxusr/tools/Vivado/2024.2/data/xilinx_vip/include" \
...
elaborate()
{
  xmelab $xmelab_opts $design_libs_elab xil_defaultlib.layernorm_axi_wrapper_0 xil_defaultlib.glbl
}

# RUN_STEP: <simulate>
simulate()
{
  xmsim $xmsim_opts xil_defaultlib.layernorm_axi_wrapper_0 -input simulate.do
}
...
reset_run()
{
  files_to_remove=(xmvlog.log xmvhdl.log xmsc.log compile.log elaborate.log simulate.log diag_report.log xsc_report.log layernorm_axi_wrapper_0_sc.so .tmp_log xcelium_lib waves.shm c.obj)
