...
#
# Script generated by Vivado on Wed May 13 13:43:28 KST 2026
# SW Build 5239630 on Fri Nov 08 22:34:34 MST 2024
#
# Copyright 1986-2022 Xilinx, Inc. All Rights Reserved.
# Copyright 2022-2024 Advanced Micro Devices, Inc. All Rights Reserved. 
#
# Filename     : layernorm_axi_wrapper_0.sh
...
#
# Usage        : layernorm_axi_wrapper_0.sh
#                layernorm_axi_wrapper_0.sh [-lib_map_path] [-step] [-keep_index] [-noclean_files]*
#                layernorm_axi_wrapper_0.sh [-reset_run]
#                layernorm_axi_wrapper_0.sh [-reset_log]
#                layernorm_axi_wrapper_0.sh [-help]
#
...
#                script (type 'layernorm_axi_wrapper_0.sh -help' for more information).
#
...
# script info
echo -e "layernorm_axi_wrapper_0.sh - Script generated by export_simulation (Vivado v2024.2 (64-bit)-id)\n"
...
run()
{
  ...
  if [[ ($b_step == 1) ]]; then
    case $step in
      ...
      ;;
      * )
        echo -e "ERROR: Invalid or missing step '$step' (type \"./layernorm_axi_wrapper_0.sh -help\" for more information)\n"
        exit 1
      esac
  else
    init_lib
...
compile()
{
  vlogan -work xilinx_vip $vlogan_opts -sverilog +incdir+"/home/linuxusr/tools/Vivado/2024.2/data/xilinx_vip/include" \
  ...
  vlogan -work xil_defaultlib $vlogan_opts +v2k +incdir+"/home/linuxusr/tools/Vivado/2024.2/data/xilinx_vip/include" \
...
elaborate()
{
  vcs $vcs_elab_opts xil_defaultlib.layernorm_axi_wrapper_0 xil_defaultlib.glbl -o layernorm_axi_wrapper_0_simv
}

# RUN_STEP: <simulate>
simulate()
{
  ./layernorm_axi_wrapper_0_simv $vcs_sim_opts -do simulate.do
}
...
reset_run()
{
  files_to_remove=(ucli.key layernorm_axi_wrapper_0_simv vlogan.log vhdlan.log compile.log elaborate.log simulate.log .tmp_log .vlogansetup.env .vlogansetup.args .vcs_lib_lock scirocco_command.log lib_sc.so 64 AN.DB csrc layernorm_axi_wrapper_0_simv.daidir vcs_lib c.obj)
...
check_arg_value()
{
  ...
  if [[ ($1 == "-lib_map_path") && ($2 == "") ]];then
    echo -e "ERROR: Simulation library directory path not specified (type \"./layernorm_axi_wrapper_0.sh -help\" for more information)\n"
    exit 1
  fi
}
...
usage()
{
  msg="Usage: layernorm_axi_wrapper_0.sh [-help]\n\
Usage: layernorm_axi_wrapper_0.sh [-step]\n\
Usage: layernorm_axi_wrapper_0.sh [-lib_map_path]\n\
Usage: layernorm_axi_wrapper_0.sh [-reset_run]\n\
Usage: layernorm_axi_wrapper_0.sh [-reset_log]\n\
Usage: layernorm_axi_wrapper_0.sh [-keep_index]\n\
Usage: layernorm_axi_wrapper_0.sh [-noclean_files]\n\n\
