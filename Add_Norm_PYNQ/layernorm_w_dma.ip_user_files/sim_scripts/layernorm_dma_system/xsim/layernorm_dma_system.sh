...
#
# Script generated by Vivado on Wed May 20 16:25:53 KST 2026
# SW Build 5239630 on Fri Nov 08 22:34:34 MST 2024
#
# Copyright 1986-2022 Xilinx, Inc. All Rights Reserved.
# Copyright 2022-2024 Advanced Micro Devices, Inc. All Rights Reserved. 
#
# Filename     : layernorm_dma_system.sh
...
#
# Usage        : layernorm_dma_system.sh
#                layernorm_dma_system.sh [-lib_map_path] [-step] [-keep_index] [-noclean_files]*
#                layernorm_dma_system.sh [-reset_run]
#                layernorm_dma_system.sh [-reset_log]
#                layernorm_dma_system.sh [-help]
#
...
# script info
echo -e "layernorm_dma_system.sh - Script generated by export_simulation (Vivado v2024.2 (64-bit)-id)\n"
...
run()
{
  ...
  if [[ ($b_step == 1) ]]; then
    case $step in
      ...
      ;;
      * )
        echo -e "ERROR: Invalid or missing step '$step' (type \"./layernorm_dma_system.sh -help\" for more information)\n"
        exit 1
      esac
  else
    init_lib
...
elaborate()
{
  xelab --incr --debug typical --relax --mt 8  -L xil_defaultlib -L axi_infrastructure_v1_1_0 -L axi_vip_v1_1_19 -L zynq_ultra_ps_e_vip_v1_0_19 -L lib_pkg_v1_0_4 -L fifo_generator_v13_2_11 -L lib_fifo_v1_0_20 -L lib_srl_fifo_v1_0_4 -L lib_cdc_v1_0_3 -L axi_datamover_v5_1_35 -L axi_sg_v4_1_19 -L axi_dma_v7_1_34 -L xlconstant_v1_1_9 -L proc_sys_reset_v5_0_16 -L smartconnect_v1_0 -L axi_register_slice_v2_1_33 -L xlconcat_v2_1_6 -L uvm -L xilinx_vip -L unisims_ver -L unimacro_ver -L secureip -L xpm --snapshot layernorm_dma_system xil_defaultlib.layernorm_dma_system xil_defaultlib.glbl -log elaborate.log
}

# RUN_STEP: <simulate>
simulate()
{
  xsim layernorm_dma_system -key {Behavioral:sim_1:Functional:layernorm_dma_system} -tclbatch cmd.tcl -protoinst "protoinst_files/bd_71fe.protoinst" -protoinst "protoinst_files/bd_6088.protoinst" -protoinst "protoinst_files/layernorm_dma_system.protoinst" -log simulate.log
}
...
copy_setup_file()
{
  ...
  if [[ ($lib_map_path == "") ]]; then
    lib_map_path="/home/linuxusr/tools/Vivado/2024.2/data/xsim"
  fi
...
reset_run()
{
  files_to_remove=(xelab.pb xsim.jou xvhdl.log xvlog.log compile.log elaborate.log simulate.log xelab.log xsim.log run.log xvhdl.pb xvlog.pb layernorm_dma_system.wdb xsim.dir libdpi.so)
...
check_arg_value()
{
  ...
  if [[ ($1 == "-lib_map_path") && ($2 == "") ]];then
    echo -e "ERROR: Simulation library directory path not specified (type \"./layernorm_dma_system.sh -help\" for more information)\n"
    exit 1
  fi
}
...
usage()
{
  msg="Usage: layernorm_dma_system.sh [-help]\n\
Usage: layernorm_dma_system.sh [-step]\n\
Usage: layernorm_dma_system.sh [-lib_map_path]\n\
Usage: layernorm_dma_system.sh [-reset_run]\n\
Usage: layernorm_dma_system.sh [-reset_log]\n\
Usage: layernorm_dma_system.sh [-keep_index]\n\
Usage: layernorm_dma_system.sh [-noclean_files]\n\n\
