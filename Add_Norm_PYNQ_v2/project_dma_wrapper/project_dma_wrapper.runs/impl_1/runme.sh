...
HD_PWD='/home/esoc/Workspace/HJH/project_dma_wrapper/project_dma_wrapper.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log ps_dma_ip_wrapper.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source ps_dma_ip_wrapper.tcl -notrace
