...
HD_PWD='/home/esoc/Workspace/HJH/project_dma_wrapper/project_dma_wrapper.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log ps_dma_ip_wrapper.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source ps_dma_ip_wrapper.tcl
