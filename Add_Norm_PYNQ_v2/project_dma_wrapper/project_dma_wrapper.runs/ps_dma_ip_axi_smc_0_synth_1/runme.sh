...
HD_PWD='/home/esoc/Workspace/HJH/project_dma_wrapper/project_dma_wrapper.runs/ps_dma_ip_axi_smc_0_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log ps_dma_ip_axi_smc_0.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source ps_dma_ip_axi_smc_0.tcl
