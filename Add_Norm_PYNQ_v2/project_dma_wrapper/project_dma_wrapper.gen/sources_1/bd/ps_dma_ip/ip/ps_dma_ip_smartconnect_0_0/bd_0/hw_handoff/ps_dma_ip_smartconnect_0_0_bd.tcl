...
################################################################
# This is a generated script based on design: bd_bdc1
#
...
proc create_hier_cell_m01_exit_pipeline { parentCell nameHier } {
  ...
  set_property -dict [ list \
   ...
   CONFIG.SSC002_ROUTE {0b1001} \
   CONFIG.SSC003_ROUTE {0b1001} \
   CONFIG.SSC004_ROUTE {0b1101} \
