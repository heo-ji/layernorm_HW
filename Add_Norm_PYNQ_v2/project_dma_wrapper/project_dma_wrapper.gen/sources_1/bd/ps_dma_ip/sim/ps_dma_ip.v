...
//Date        : Wed May 20 18:41:16 2026
//Host        : esoc-System-Product-Name running 64-bit Ubuntu 20.04.6 LTS
//Command     : generate_target ps_dma_ip.bd
//Design      : ps_dma_ip
//Purpose     : IP block netlist
//--------------------------------------------------------------------------------
`timescale 1 ps / 1 ps

(* CORE_GENERATION_INFO = "ps_dma_ip,IP_Integrator,{x_ipVendor=xilinx.com,x_ipLibrary=BlockDiagram,x_ipName=ps_dma_ip,x_ipVersion=1.00.a,x_ipLanguage=VERILOG,numBlks=7,numReposBlks=7,numNonXlnxBlks=1,numHierBlks=0,maxHierDepth=0,numSysgenBlks=0,numHlsBlks=0,numHdlrefBlks=0,numPkgbdBlks=0,bdsource=USER,da_axi4_cnt=2,da_clkrst_cnt=5,da_zynq_ultra_ps_e_cnt=1,synth_mode=OOC_per_IP}" *) (* HW_HANDOFF = "ps_dma_ip.hwdef" *) 
module ps_dma_ip
   ();
  ...
  wire [127:0]layernorm_axi_wrapper_0_m00_axis_TDATA;
  ...
  ps_dma_ip_axi_dma_0_0 axi_dma_0
  ...
  ps_dma_ip_layernorm_axi_wrapper_0_0 layernorm_axi_wrapper_0
       (.m00_axis_aclk(zynq_ultra_ps_e_0_pl_clk0),
        .m00_axis_aresetn(rst_ps8_0_96M_peripheral_aresetn),
        ...
        .s00_axis_aresetn(rst_ps8_0_96M_peripheral_aresetn),
  ...
  ps_dma_ip_rst_ps8_0_96M_0 rst_ps8_0_96M
       (.aux_reset_in(1'b1),
        .dcm_locked(1'b1),
  ...
  ps_dma_ip_smartconnect_0_0 smartconnect_0
       (.M00_AXI_araddr(smartconnect_0_M00_AXI_ARADDR),
        ...
        .aclk(zynq_ultra_ps_e_0_pl_clk0),
        .aresetn(rst_ps8_0_96M_peripheral_aresetn));
  ps_dma_ip_xlconcat_0_0 xlconcat_0
       (.In0(axi_dma_0_mm2s_introut),
        .In1(axi_dma_0_s2mm_introut),
        .dout(xlconcat_0_dout));
  ps_dma_ip_zynq_ultra_ps_e_0_0 zynq_ultra_ps_e_0
       (.emio_uart1_rxd(1'b0),
